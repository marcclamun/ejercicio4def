...
function OptionButton({ option, handlePlay, disabled }) {
  return (
    <button
      className="px-6 py-2 m-2 text-xl font-bold text-white bg-blue-500 rounded-full hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-orange-400 disabled:opacity-50 disabled:cursor-not-allowed"
      disabled={disabled}
...
export default function Game() {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-blue-800">
      <div className="rounded-lg p-4 bg-yellow-500">
